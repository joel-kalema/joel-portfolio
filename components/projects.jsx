        ...
        <div className="pt-24 lg:pt-40 px-4 lg:px-20">
            <ParallaxProvider>
                ...
                <div className="flex justify-between gap-6 items-center my-10 lg:my-40 mix-blend-difference">
                    ...
                    <div className="h-[4px] w-2/6 bg-[#FFFFE3] mix-blend-difference hidden lg:block"></div>
                    <h1 className="text-4xl lg:text-7xl font-semibold">Projects</h1>
                </div>
            </ParallaxProvider>

            <div className="mt-40 lg:flex justify-center flex-wrap text-[#FFFFE3]" id="portfolio">
                {projects.map((project) => (
                    <div
                        key={project.title}
                        className="lg:w-[45%] mb-12 lg:mb-0 relative overflow-hidden grayscale hover:grayscale-0 transition duration-300 border border-dotted border-[#2a2a26] group"
                    >
                        <div className="lg:p-4 h-[12rem] lg:h-[17rem] overflow-hidden relative z-20">
