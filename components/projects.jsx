...
const Projects = () => {
    ...
    return (
        <div className='py-40 px-20'>
            <div className='w-4/6 mx-auto text-center mb-40'>
                <h1 className='italic text-xl mb-4'>SINCE 2020</h1>
                <h1 className='uppercase text-3xl'>I HAVE BEEN WORKING ON Innovative solutions crafted to solve real-world challenges.
